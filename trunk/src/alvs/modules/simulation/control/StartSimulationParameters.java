...
public class StartSimulationParameters extends SimpleParameterSet {
        ...
        public static final Parameter repProbability = new SimpleParameter(
                ...
                "Probability of reproduction when 2 bugs are compatible", new Double(0.3));
        public static final Parameter correlationThreshold = new SimpleParameter(
                ParameterType.DOUBLE, "Correlation coefficient threshold",
                "Correlation coefficient threshold shown in the results", new Double(0.7));

        public StartSimulationParameters() {
                super(new Parameter[]{iterations, worldSize, bugLimit, numberOfBugs,
                bugLife, classifier, stoppingCriteria, numberOfVariables, repProbability, correlationThreshold});
        }
}
