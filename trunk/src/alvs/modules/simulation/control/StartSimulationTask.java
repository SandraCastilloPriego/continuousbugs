...
public class StartSimulationTask {
        ...
        int[] counter;
        private double correlationThreshold, repProbability;
        ...
        public StartSimulationTask(BugDataset[] datasets, SimpleParameterSet parameters) {
                ...
                this.correlationThreshold =(Double) parameters.getParameterValue(StartSimulationParameters.correlationThreshold);
        ...
        public void printResult(List<Bug> bugs, Range range) {
                ...
                for (Bug bug : bugs) {
                        if (bug.getFMeasure() > this.correlationThreshold) {
